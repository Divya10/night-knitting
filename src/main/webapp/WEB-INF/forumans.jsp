...
<body>
	<nav>
		<div class="nav-wrapper blue darken-1">
			<a href="dashboard" class="brand-logo" style="margin-left: 30px;"></a>
	...
	<div id="main">
		<div id="ques" class="z-depth-1" align="center">
			...
			<table class=" bordered highlight ">
				...
				<c:forEach var="question" items="${notice}">
					<tr>
						<td id="index"><%=i%>.</td>
						<td style="min-width: 750px;"><a
							href="ans?id=${question.quesid}"><c:out
									value="${question.ques}" /></a></td>
					</tr>
					<%
						i = i + 1;
					%>
