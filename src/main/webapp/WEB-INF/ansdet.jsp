...
<div class="card col s6 offset-s3"
   ...
   <div id="ques_form" align="center"> 	
         ...
         <div class="input-field col s6">
					<input type="text" name="quesid" value="${quesid}"><label
						for="question id">ques id</label>
				</div>
        ...
        <div class="input-field col s6">
         ...
         <div class="input-field col s6">
					<textarea id="detail" name="answer" required></textarea> <label
						for="question id">enter answer</label>
				</div>
